...
/// Segmented vec implemented as a simple "vector of vectors" with fixed chunk size.
///
/// pushing many elements into it performs worse than a simple vec because the fixed
/// size chunks lead to more allocations than Vec's exponential growth strategy even
/// if it can skip the copy.
